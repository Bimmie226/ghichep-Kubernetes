...
- Immediate: Khi muốn volume được tạo ngay lập tức sau khi StorageClass được định nghĩa 
- WaitForFirstConsumer: khi muốn volume chỉ được tạo khi có 1 Pod yêu cầu sử dụng 
